package com.logoxiang.practice.entity;
 ...
 */
public class TimingInterface implements Serializable {

    private static final long serialVersionUID = -2000063761972320895L;
    ...
    public void setInterfaceRemark(String interfaceRemark) {
        this.interfaceRemark = interfaceRemark == null ? null : interfaceRemark.trim();
    }
    ...
    public void setTriggerStrategy(String triggerStrategy) {
        this.triggerStrategy = triggerStrategy == null ? null : triggerStrategy.trim();
    }
    ...
    public String getRespProcessor() {
        return respProcessor;
    }

    public void setRespProcessor(String respProcessor) {
